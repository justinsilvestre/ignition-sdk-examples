...
public class ScadaTorchMap  {
    ...
    public static JsonSchema SCHEMA =
        JsonSchema.parse(RadComponents.class.getResourceAsStream("/radscadatorchmap.props.json"));
